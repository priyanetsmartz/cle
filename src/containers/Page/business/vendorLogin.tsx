                ...
                <div className="row g-3">
                  ...
                  <div className="col-6">
                    <div className="float-end">
                      ...
                      <a href="" className="forgot-pswd-new float-end">forgot your password?</a>
                    </div>
                ...
                <div className="row g-3">
                  ...
                  <div className="col-8">
                    <div className="float-end">
                      ...
                      <p className="float-end text-end">By registering you agree with our <a href="">Terms & Conditions</a>
