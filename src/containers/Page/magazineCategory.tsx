...
function MagazineCategory(props) {
    ...
    const intl = useIntl();
    const { magazinecategory }: any = useParams();
    ...
    useEffect(() => {
        ...
        if (magazinecategory) {
            setOpacity(0.3);
            getDataOfCategory(lang, magazinecategory, 1, 'published_at', 'desc')
        } else {
    ...
    }, [props.languages, magazinecategory])
    ...
    const filtterData = (event) => {
        ...
        setOpacity(0.3);
        if (magazinecategory) {
            getDataOfCategory(lang, magazinecategory, 1, sortBy, sortByValue)
        } else {
    ...
    return (
        <>
            ...
            {latest && (<div className="highlight-list py-5">
