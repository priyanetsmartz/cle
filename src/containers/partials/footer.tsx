...
function Footer() {
    ...
    return (
        <div className="modal fade signup-Modal" id="signUpModal" aria-labelledby="signUpModalLabel" aria-hidden="true">
            <div className="modal-dialog">
                <div className="modal-content">
                    ...
                    <div className="modal-body signup_inner">
                        ...
                        <p className="signup-policy-links">By registering you agree with our <a href="">Terms & Conditions</a> and <a href="">Privacy Policy</a>.</p>
                    </div>
