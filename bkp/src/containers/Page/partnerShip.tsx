    ...
    return (
        <div className="container about-inner">
            <figure className="text-center partnership-title page-head">
				...
				<svg xmlns="http://www.w3.org/2000/svg" width="1050" height="125" viewBox="0 0 1050 125">
  <text id="{pagesData.title}" data-name="{pagesData.title}" transform="translate(525 91)" fill="none" stroke="#2e2baa" stroke-width="1" font-size="102" font-family="Monument Extended Book"><tspan x="-523.923" y="0">{pagesData.title}</tspan></text> </svg>
